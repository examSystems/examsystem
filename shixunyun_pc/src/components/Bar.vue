<template>
  <div class="height_100">
    ...
    <el-menu
      default-active="/Stu/class"
      class="el-menu-vertical-demo barBg"
      @open="handleOpen"
      @close="handleClose"
      :collapse="idCollapse"
      router
